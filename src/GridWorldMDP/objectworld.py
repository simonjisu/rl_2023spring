...
"""
"""
modified by Sehee Kweon for RL project 2023
"""
...
class Objectworld(GridWorld):
    ...
    def __init__(self, grid_size, n_objects, n_colours, trans_prob, discount=0):
        """
        grid_size: Grid size. int.
        n_objects: Number of objects in the world. int.
        n_colours: Number of colours to colour objects with. int.
        trans_prob: Chance of moving randomly. float.
        discount: MDP discount. float.
        -> Objectworld
        """
        
        super().__init__(np.zeros([grid_size, grid_size]), {}, trans_prob)
        ...
        self.P_a = self.get_transition_mat()
