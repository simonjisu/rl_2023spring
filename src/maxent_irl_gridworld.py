...
def run_maxent_irl(args, coor_rates: list[tuple[tuple[int, int], float]], init_start_pos=None):
    env, P_a, rewards_gt, values_gt, policy_gt = init_grid_world(args, coor_rates)
